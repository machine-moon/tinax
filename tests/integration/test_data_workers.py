...
from tinax.data import open_multiprocessing_iterator
...
def test_workers_close_on_early_context_exit_and_receive_options(tmp_path: Path, _parsed_absl_flags: None) -> None:
    existing = _grain_worker_pids()
...
def test_installed_example_bootstraps_abseil_before_starting_workers() -> None:
    completed = subprocess.run(
        [sys.executable, "-m", "examples.data.deterministic_pipelines"],
