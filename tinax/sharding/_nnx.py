...
def abstract_sharded_state[T](
    initializer: _Callable[[], T], mesh: _jax.sharding.Mesh
) -> _nnx.GraphState[T]:
...
def state_shardings[StateMapping: _Mapping](
    state: StateMapping, mesh: _jax.sharding.Mesh
) -> StateMapping:
