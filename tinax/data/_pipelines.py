...
from tinax.data._generic import BatchTransform as _BatchTransform
...
def _sharding_options(options: object, *, drop_remainder: bool) -> _grain.sharding.ShardOptions:
...
def _shard_dataset[T](dataset: _grain.MapDataset[T], options: _grain.sharding.ShardOptions) -> _grain.MapDataset[T]:
